                ...
                <div class="w-full max-w-screen-xl mx-auto">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="flex flex-wrap gap-3 justify-center items-center">
                            ...
                            <a id="tambahKunjungan" href="{{ route('kunjungan.form') }}" class="flex gap-2 px-2 py-1 justify-center items-center bg-[#029C55] rounded-sm text-white font-bold shadow-sm cursor-pointer hidden">
