<div class="h-fit min-h-[400px] gap-3 p-4 mt-10 overflow-auto bg-white rounded-xl shadow-sm">
<!--begin::Table-->
    <table id="tableKunjungan" class="table-auto w-full text-sm">
        ...
        <tbody id="bodyKunjungan" class="text-left font-bold">
            <tr class="border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">
                    <div class="p-1 border border-[#fad230] rounded-full text-center text-[#fad230] font-medium">Menunggu</div>        
                </td>
                <td>
            ...
            <tr class="bg-white border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">Contoh data 3</td>
                <td class="px-4 py-3">08/07/2025</td>
            ...
            <tr class="bg-white border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">Contoh data 4</td>
                <td class="px-4 py-3">08/07/2025</td>
            ...
            <tr class="bg-white border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">Contoh data 5</td>
                <td class="px-4 py-3">08/07/2025</td>
            ...
            <tr class="bg-white border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">Contoh data 6</td>
                <td class="px-4 py-3">08/07/2025</td>
            ...
            <tr class="bg-white border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">Contoh data 7</td>
                <td class="px-4 py-3">08/07/2025</td>
            ...
            <tr class="bg-white border-b border-[#029C5525]">
                ...
                <td class="px-4 py-3">Contoh data 8</td>
                <td class="px-4 py-3">08/07/2025</td>
