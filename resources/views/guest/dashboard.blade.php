        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="p-4 gap-4">
                ...
                <div class="flex flex-row gap-3">
                    ...
                    <div class="flex flex-col gap-2 w-64 p-5 bg-white rounded-lg justify-around">
                ...
                <div class="bg-white rounded-lg gap-3">
                    <table class="table-fixed">
                        ...
                        <tbody>
                            <tr>
                                <td>Maitsa Luthfiyyah</td>
                                <td>Telkom University</td>
                                <td>08/07/2025</td>
                                <td>Ian Mariana Wati</td>
                                <td>MIS</td>
                                <td>Menunggu</td>
                            </tr>
                        </tbody>
