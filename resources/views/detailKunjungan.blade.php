            ...
            <main class="p-4 gap-4 m-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 sm:p-10 mt-6 bg-white rounded-xl shadow-sm">
                    ...
                    <div class="flex flex-col h-full justify-center items-center">
                        <div class="mb-3 justify-center items-center text-center hidden sm:block">
                    ...
                    <div class="flex-col space-y-3">
                        ...
                        <div class="block sm:hidden space-y-3">
                            <div class="flex flex-col sm:flex-row">
                                ...
                                <div class="text-black font-medium">Maitsa Luthfiyyah</div>
                            </div>
                            <div class="flex flex-col sm:flex-row">
                                <div class="w-48 text-gray-500">Instansi</div>
                                <div class="text-black font-medium">Telkom University</div>
                            </div>
                            <div class="flex flex-col sm:flex-row">
                                <div class="w-48 text-gray-500">No. Identitas</div>
                                <div class="text-black font-medium">maitsaaaaaaa.jpg</div>
                            </div>
                            <div class="flex flex-col sm:flex-row">
                                <div class="w-48 text-gray-500">Status</div>
                                <div id="statusBox" class="w-fit p-1 px-4 border border-[#fad230] rounded-full text-[#fad230] text-center font-medium">Menunggu</div>
                            </div>
                        </div>
                        <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex flex-wrap gap-2 justify-end items-end text-sm">
                            <button onclick=ubahStatus() class="flex gap-2 p-2.5 px-3 sm:px-4 justify-center items-center border border-[#029C55] rounded-lg text-xs sm:text-sm text-[#029C55] font-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#029C55" class="size-4">
                                    <path fill-rule="evenodd" d="M19.916 4.626a.75.75 0 0 1 .208 1.04l-9 13.5a.75.75 0 0 1-1.154.114l-6-6a.75.75 0 0 1 1.06-1.06l5.353 5.353 8.493-12.74a.75.75 0 0 1 1.04-.207Z" clip-rule="evenodd" />
                                </svg>
                                Selesai
                            </button>
                            <button class="flex gap-2 p-2.5 px-3 sm:px-4 justify-center items-center bg-[#029C55] rounded-lg text-xs sm:text-sm text-white font-bold">
                            ...
                            <button class="flex gap-2 p-2.5 px-3 sm:px-4 justify-center items-center border border-[#E21B1B] rounded-lg text-xs sm:text-sm text-[#E21B1B] font-bold">
