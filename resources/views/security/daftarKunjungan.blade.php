...
<head>
    ...
    @vite(['resources/js/daftarKunjungan.js'])
...
<body class="min-h-screen bg-[#E8F5EC] overflow-x-hidden">
                ...
                <div class="w-full max-w-screen-xl mx-auto">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="flex flex-wrap gap-3 justify-center items-center">
                            ...
                            <!--begin::Filter button-->
                            <button id="filterButton" class="relative">
                            ...
                            <a href="{{ route('kunjungan.form') }}" class="flex gap-2 px-2 py-1 justify-center items-center bg-[#029C55] rounded-sm text-white font-bold shadow-sm cursor-pointer">
    ...
    @vite(['resources/js/modal.js', 'resources/js/daftarKunjungan.js'])
</body>
</html>