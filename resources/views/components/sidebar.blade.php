        ...
        <div id="main-content" class="justify-between">
            <div class="m-3 items-center w-full">
                <ul class="justify-center">
                    ...
                    <li>
                        <a href="/daftar-kunjungan" class="flex items-center m-3 p-2.5 gap-3 text-[#908787] text-md rounded-2xl transition duration-300 ease-in-out hover:bg-[#029C558C] hover:text-[#01562f]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
