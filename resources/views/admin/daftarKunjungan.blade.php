                    ...
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="flex flex-wrap justify-center items-center gap-3">
                            ...
                            <div class="flex items-center gap-2 text-sm">
                                ...
                                <div id="dropdownEntriesMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm">
                            ...
                            <a href="/form-kunjungan" class="flex px-2 py-1 bg-[#029C55] rounded-sm gap-2 items-center justify-center text-white font-bold cursor-pointer">
